...
function Navbar() {
  ...
  return (
    <div>
      <div className="flex justify-between bg-no-repeat bg-cover bg-center px-3 py-2 items-center" style={{backgroundImage: `url(${Nav_Back})`}}>
        ...
        <div>
          ...
          <div className="block lg:hidden">
            <svg xmlns="http://www.w3.org/2000/svg" onClick={() => setMenu(temp)} className="text-white h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
      ...
      <div className={menu}>
        <div className="bg-cyan-800 text-2xl text-white lg:hidden grid grid-cols-1 divide-y">
